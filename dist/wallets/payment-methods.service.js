...
let PaymentMethodsService = class PaymentMethodsService {
    ...
    async create(userId, createPaymentMethodDto) {
        if (createPaymentMethodDto.type === client_1.PaymentMethodType.CREDIT_CARD) {
        ...
        const availableLimit = createPaymentMethodDto.type === client_1.PaymentMethodType.CREDIT_CARD
    ...
    async update(id, userId, updateData) {
        ...
        if (paymentMethod.type === client_1.PaymentMethodType.CREDIT_CARD || updateData.type === client_1.PaymentMethodType.CREDIT_CARD) {
