...
let WalletsV2Controller = class WalletsV2Controller {
    ...
    async getstrings() {
        return {
            types: [
                {
                    value: string.DIGITAL_WALLET,
                    label: 'Carteira Digital',
                    icon: 'smartphone',
                    description: 'Nubank, Mercado Pago, PicPay, etc.'
                },
                {
                    value: string.TRADITIONAL_BANK,
        ...
        try {
            ...
            groups.forEach(group => {
                group.paymentMethods.forEach(method => {
                    ...
                    if (method.type === string.CREDIT_CARD) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof create_wallet_group_dto_1.CreateWalletGroupDto !== "undefined" && create_wallet_group_dto_1.CreateWalletGroupDto) === "function" ? _a : Object, Object]),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], WalletsV2Controller.prototype, "getstrings", null);
__decorate([
...
__decorate([
    ...
    __param(1, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_b = typeof create_payment_method_dto_1.CreatePaymentMethodDto !== "undefined" && create_payment_method_dto_1.CreatePaymentMethodDto) === "function" ? _b : Object, Object]),
    __metadata("design:returntype", Promise)
