...
ADD COLUMN     "notificationSettings" JSONB NOT NULL DEFAULT '{"budget_alerts":true,"bill_reminders":true,"transaction_confirmations":true}',
ADD COLUMN     "pinCode" TEXT,
ADD COLUMN     "themePreference" "public"."ThemePreference" NOT NULL DEFAULT 'SYSTEM';
